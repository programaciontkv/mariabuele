                 ...
                 <table class="table col-sm-12" border="0">
                    <tr>
                      <td class="col-sm-5">
                        ...
                        <table class="table">
                            <tr>
                              <td><label><th class="hidden">Familia:</label></td>
                              <td colspan="2">
                                <div class="hidden">"form-group <?php if(form_error('mp_a')!=''){ echo 'has-error';}?>">
                                    <select name="mp_a" id="mp_a" class="form-control" onchange="load_tipo()">
                                      <option value="th class="hidden>SELECCIONE</option>
                                      <?php
                            ...
                            <tr>
                                <td><label><th class="hidden">Tipo</label></td>
                                <td colspan="2">
                                  <div class="hidden">"form-group <?php if(form_error('mp_b')!=''){ echo 'has-error';}?> ">
                            ...
                            <tr>
                                <td><label><th class="hidden">Codigo Aux:</label></td>
                                <td>
                                  <div class="hidden">"form-group <?php if(form_error('mp_n')!=''){ echo 'has-error';}?> ">
