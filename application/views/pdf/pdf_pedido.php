        ...
        <td colspan="2">
            ...
            <table id="detalle" width="100%"   class="table table-bordered table-list table-hover table-striped page-break" >
                <thead class="sub_titulo">
                    <tr>
                       ...
                       <?php }
                        ?>
                        <th style="width:3px"> <strong>Cantidad</strong> </th>
                        <th style="width:30px"><strong>V.Unitario $</strong>  </th>
                        <!-- <th style="width:70px">% IVA</th>
                        <th style="width:70px">% Descuento</th> -->
                        <th style="width:30px"> <strong>V.Total $</strong> </th>
                    </tr> 
                </thead> 
                <tbody >
                    <?php
                ...
                <tr >
                        <td  style="width:80px;<?php echo $height ?>"><?php echo $det->det_cod_producto?></td>
            ...
            <tr class="pagos">
                <td class="pagos" colspan="2">
                        <table >
                        <tr>
                        <td width="100px"><strong>Forma de Pago</strong></td>
            ...
            <?php
                        ...
                        ?>
                        <tr>
                        <td width="100px" ><?php echo $rst_pag->fpg_codigo.' - '.ucwords(strtolower($rst_pag->fpg_descripcion_sri))?></td>
