...
public function buscar_cliente($txt){
    ...
    public function show_talon($id,$opc_id,$correo,$etiqueta){
            ...
            $this->html7pdf->filename('talon.pdf');
			$this->html7pdf->paper(array(0,0,204.75,533.66),'portrait');
    		$this->html7pdf->html(utf8_decode($this->load->view('pdf/pdf_talon',$data, true)));
			...
			if($correo==1){
				...
				$this->html7pdf->output(array("Attachment" => 0));	
			}
